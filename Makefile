...
ALL_TARGETS += triton-origin-x86_64-22.4.0-%
...
triton-origin-x86_64-22.4.0-%:
	@echo '$*'
	rm make_stamps ; ln -s images/triton-origin-x86_64-22.4.0/make_stamps make_stamps
	cd images/triton-origin-x86_64-22.4.0 && $(MAKE) $*
